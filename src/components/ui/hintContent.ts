...
export const measurementHints = {
  ...
  trends: hintFacts([['Selected', 'Active time by starting hour/date'], ['Previous', 'Equal-length period, same final-day cutoff']], 'Completed observations only.'),
  ...
  intervals: hintFacts([['Position', 'Local clock time'], ['Span', 'Elapsed time; dashed ends are clipped'], ['Muted', 'Outside selected evidence']], 'Active totals use selected time by view start date.'),
